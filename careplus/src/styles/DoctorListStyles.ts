const styles = {
  ...
  emptyText: "text-gray-600 dark:text-gray-300",
  ...
  deleteButton:
    "px-3 py-1 bg-slate-700 dark:[background-color:oklch(47.6%_0.114_61.907)] text-white border-0 rounded cursor-pointer transition text-sm hover:bg-slate-800",
};
