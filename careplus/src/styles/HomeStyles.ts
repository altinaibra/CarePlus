...
export const HomeStyles = {
  ...
  subtitle: "text-base md:text-lg text-gray-600 dark:text-gray-300 mb-6 md:mb-10",

  sectionHeaderContainer: "flex items-center justify-center md:justify-center mb-4 md:mb-6",
  ...
  cardsContainer: "flex flex-wrap justify-center gap-3 md:gap-5 max-w-4xl mx-auto",
};
